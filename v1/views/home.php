        ...
        <?php foreach ($services as $svc) { ?>
          <div class="service-card">
            ...
            <div class="service-card-body">
              <h3 class="service-card-title" data-admc-manage="panel_services" data-admc-id="<?= $svc['id'] ?>"><?= $svc['input_title'] ?></h3>
              ...
              <div class="service-card-price">
                ...
                <a class="service-card-link" href="<?= $svc['input_link_url'] ?>" data-admc-manage="panel_services" data-admc-id="<?= $svc['id'] ?>"><?= $svc['input_link_text'] ?></a>
              </div>
            </div>
          </div>
        <?php } ?>
