...
<section id="why" class="section section-dark">
  <div class="container">
    <div class="section-header text-center">
      <span class="section-label" data-admc-manage="settings_home_why" data-admc-id="<?= $whyHeader['id'] ?>"><?= $whyHeader['input_label'] ?></span>
      <h2 class="section-title" data-admc-manage="settings_home_why" data-admc-id="<?= $whyHeader['id'] ?>"><?= $whyHeader['input_title'] ?></h2>
      <p class="section-subtitle mx-auto" data-admc-manage="settings_home_why" data-admc-id="<?= $whyHeader['id'] ?>"><?= $whyHeader['text_subtitle'] ?></p>
    </div>

    <div class="grid grid-cols-1 gap-7 md:grid-cols-2 lg:grid-cols-3" data-admc-tb="panel_why_us">
      <?php foreach ($whyCards as $card): ?>
        <div class="why-card reveal">
          <div class="why-icon" data-admc-manage="panel_why_us" data-admc-id="<?= $card['id'] ?>"><i class="<?= htmlspecialchars($card['input_icon']) ?>"></i></div>
