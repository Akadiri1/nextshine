 ...
 * POST /quote-request
 *
 * Receives the quote forms (JSON, fields named as in www/assets/js/app.js),
 * emails a confirmation to the customer when they gave an address, and the
 * full request to the business. Responds with {success} or {failed}.
 */
